...
{
    private int WINDOW_WIDTH = 1280;     //Window width
    private int WINDOW_HEIGHT = 720;    //Window height

    private int CENTREPANEL_WIDTH = WINDOW_WIDTH-233; //=1077   Half 538
    private int CENTREPANEL_HEIGHT = WINDOW_HEIGHT - 155; //620
