...
public class mainmenu extends javax.swing.JFrame {
    ...
    private PopupMenu hel;
    private PopupMenu help;

    public mainmenu() {
        super.setTitle("Bank of The Professor");
    ...
    private void initComponents() {
        ...
        jMenuItem7.setText("Customer Report(Cusreport)");
        ...
        jMenuItem9.setText("Creating Account");
    ...
    private void jMenuItem10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem10ActionPerformed
        String h="";
        if(help.equals(h)){
            JOptionPane.showConfirmDialog(jDesktopPane1, "bakangmonei2@gmail.com");
        }
        help hel= new help();
        jDesktopPane1.add(help);
        hel.setVisible(true);
        help.addActionListener((ActionEvent ae)->{
            JOptionPane.showConfirmDialog(jDesktopPane1, "bakangmonei2@gmail.com");
        });
